...
public class ExecuteProgramController {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> indexColumnSemaphoreTable;

    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, Integer> NLColumnSemaphoreTable;

    @FXML
    private TableColumn<Map.Entry<Integer, Pair<Integer, List<Integer>>>, String> threadsColumnSemaphoreTable;
    ...
    public void initialize() {
        ...
        // set the cell factory for the semaphore table
        this.indexColumnSemaphoreTable.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getKey()).asObject());
        this.NLColumnSemaphoreTable.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getValue().getKey()).asObject());
        this.threadsColumnSemaphoreTable.setCellValueFactory(param -> new SimpleStringProperty(param.getValue().getValue().getValue().toString()));
    }
    public void setStatement(StatementInterface newStatement, String logFilePath) {
        ProgramState programState = new ProgramState(new MyStack<>(), new MyDictionary<>(), new MyList<>(),
                new MyDictionary<>(), new MyHeap<>(), new MySemaphoreTable(), newStatement);
        try {
