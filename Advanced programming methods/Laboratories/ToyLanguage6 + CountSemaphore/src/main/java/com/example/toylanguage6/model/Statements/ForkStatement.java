...
//        newExecutionStack.push(forkStatement);
        ...
        ProgramState newProgramState = new ProgramState(newExecutionStack, newSymbolTable, state.getOutput(), state.getFileTable(), state.getHeap(), state.getSemaphoreTable(), forkStatement);
