...
import com.example.toylanguage6.model.ADTs.MyProcedureTable;
import com.example.toylanguage6.model.ADTs.MyProcedureTableInterface;
import com.example.toylanguage6.model.Statements.AssignStatement;
import com.example.toylanguage6.model.Statements.CompoundStatement;
import com.example.toylanguage6.model.Statements.StatementInterface;
import com.example.toylanguage6.model.Statements.VariableDeclarationStatement;
...
public class ChooseProgramToExecuteController {
    ...
    private final MyProcedureTableInterface procedureTable = new MyProcedureTable();
    ...
    public void initialize() {
        ...
        programsList.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<StatementInterface>() {
            ...
            public void changed(ObservableValue<? extends StatementInterface> observableValue, StatementInterface oldStatement, StatementInterface newStatement) {
                ...
                executeProgramController.setStatement(newStatement, procedureTable, filename);
            }
        });
    }
    ...
    private ObservableList<StatementInterface> getExamples() {
        ...
        StatementInterface f1 = new CompoundStatement(
                new VariableDeclarationStatement("s", new IntType()),
                new CompoundStatement(
                        new AssignStatement("s", new ArithmeticExpression('+', new VariableExpression("a"), new VariableExpression("b"))),
                        new PrintStatement(new VariableExpression("s"))
                )
        );
        StatementInterface f2 = new CompoundStatement(
                new VariableDeclarationStatement("p", new IntType()),
                new CompoundStatement(
                        new AssignStatement("p", new ArithmeticExpression('*', new VariableExpression("a"), new VariableExpression("b"))),
                        new PrintStatement(new VariableExpression("p"))
                )
        );

        try {
            procedureTable.add("sum", new Pair<>(Arrays.asList("a", "b"), f1));
            procedureTable.add("product", new Pair<>(Arrays.asList("a", "b"), f2));
        } catch (Exception e) {
            e.printStackTrace();
        }
                                ...
                                new CompoundStatement(
                                        ...
                                        new CompoundStatement(
                                                ...
                                                new CompoundStatement(
                                                        ...
                                                        new ForkStatement(
                                                                new CompoundStatement(
                                                                        new FunctionCallStatement("product", Arrays.asList(new VariableExpression("v"), new VariableExpression("w"))),
                                                                        new ForkStatement(
                                                                                new FunctionCallStatement("sum", Arrays.asList(new VariableExpression("v"), new VariableExpression("w"))))
                                                                )
                                                        )
