...
import com.example.toylanguage6.model.ADTs.MySemaphoreTableInterface;
...
//        this.executor = Executors.newFixedThreadPool(2);
    ...
    public void oneStepForAllPrograms(List<ProgramState> programStateList) throws InterpreterException {
        List<Callable<ProgramState>> callList = programStateList.stream()
                ...
                .collect(Collectors.toList());
        // However, the returned list of Future objects is strictly ordered to match the input list of tasks, regardless of the execution order.
        Collections.shuffle(callList); // this makes the outcome random
    ...
    public MySemaphoreTableInterface getSemaphoreTable() {
        return this.getProgramStatesList().get(0).getSemaphoreTable();
    }
}
